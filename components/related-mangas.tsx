...
import { Star, BookOpen, Eye, TrendingUp, Sparkles } from "lucide-react";
                ...
                <Card className="group relative overflow-hidden bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-950/90 border border-white/5 hover:border-pink-500/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-pink-500/25 backdrop-blur-xl h-full">
                  ...
                  <div className="relative py-0 sm:px-4 flex flex-col h-full">
                    ...
                    <div className="flex gap-3 sm:gap-4 mb-3">
                      {/* Cover Image */}
                      <div className="relative w-20 sm:w-24 h-28 sm:h-32 flex-shrink-0 rounded-lg overflow-hidden shadow-2xl ring-1 ring-white/10 group-hover:ring-pink-500/30 transition-all duration-300">
                        <img
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center">
                        <h3 className="font-bold text-sm sm:text-base line-clamp-2 mb-1.5 text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-purple-400 group-hover:bg-clip-text transition-all duration-300">
                          {manga.title}
                        </h3>
