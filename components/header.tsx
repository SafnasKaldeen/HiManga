...
export function Header() {
  ...
  return (
    <header className="border-b border-white/10 bg-[#0a0a1a]/80 backdrop-blur-xl sticky top-0 z-50">
      ...
      <div
        className={`fixed top-[80px] right-0 w-full sm:w-96 md:w-[400px] h-[calc(100vh-80px)] bg-[#0a0a1a]/95 backdrop-blur-xl border-l border-white/10 transform transition-transform duration-300 ease-in-out z-40 xl:hidden ${
