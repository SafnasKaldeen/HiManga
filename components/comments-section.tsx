...
export function CommentsSection({ mangaId }: CommentsSectionProps) {
  ...
  return (
    <div className="flex flex-col h-[150vh] space-y-4">
      ...
      <div className="flex flex-col h-[150vh] space-y-4">
        {/* Comment Input */}
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-3 sm:p-4 space-y-3 flex-shrink-0 shadow-md shadow-black/10">
        ...
        <div className="flex items-center justify-between flex-shrink-0">
          ...
          >
            <TabsList className="grid w-fit grid-cols-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-lg">
              <TabsTrigger
                value="newest"
        ...
        {/* Comments List */}
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-3 sm:p-4 space-y-3 flex-1">
