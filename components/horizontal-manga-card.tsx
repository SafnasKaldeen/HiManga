    ...
    <Link href={`/manga/${manga.id}`} className="block h-full">
      <Card className="group relative overflow-hidden bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-950/90 border border-white/5 hover:border-pink-500/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-pink-500/25 backdrop-blur-xl h-full">
        ...
        <div className="relative p-3 sm:p-4 flex flex-col h-full">
          {/* Cover Image */}
          <div className="relative w-full aspect-[3/4] rounded-lg overflow-hidden shadow-2xl ring-1 ring-white/10 group-hover:ring-pink-500/30 transition-all duration-300 mb-3">
            <img
