...
export default function TrendingPage() {
  ...
  const genres = ["All", "Action", "Fantasy", "Sci-Fi", "Romance", "Mystery", "Thriller", "Comedy"]
  ...
  const filteredMangas = useMemo(() => {
    ...
    // Sort
    if (sortBy === "rating") {
      result = [...result].sort((a, b) => Number.parseFloat(b.rating) - Number.parseFloat(a.rating))
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg">Discover the most popular manga this season</p>
        </div>
